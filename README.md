# Fork adapted for PF2e

* "Advance 15 minutes" button changed to "Advance 10 minutes"
* "Advance 5 minutes" button changed to "Advance 3 minutes"
* Non-english languages are unsupported

# calendar-weather
A customizable module that accurately tracks and displays dates and time.
## Links:
* Manifest: https://raw.githubusercontent.com/Ustin/calendar-weather/master/module.json
